...
/**
 * Game structure — Pick 6, no bonus
 */
$gameMainBallMin   = 1;
$gameMainBallMax   = 46;
$gameMainBallCount = 6;
$gameMainCols      = ['first', 'second', 'third', 'fourth', 'fifth', 'sixth'];
$gameHasBonus      = false;
...
if (isset($stateName, $gName) && $stateName !== '' && $gName !== '') {
    $doc->setTitle(
        ...
        ' — Pick 6 Results Analysis | LottoExpert.net'
    );
}
...
if (!function_exists('leFmtDateLong')) {
...
if (!function_exists('leResolveLogo')) {
...
if (!function_exists('leInitRange')) {
...
if (!function_exists('leDrawingsAgoLabel')) {
...
if (!function_exists('leBuildNaturalLabels')) {
...
if (!function_exists('leTopKeysByValue')) {
...
if (!function_exists('leFindRepeatedFromLatest')) {
...
if (!function_exists('leCommaList')) {
...
if (!function_exists('leFetchRecentDraws')) {
...
if (!function_exists('leGetPreviousOccurrenceDate')) {
...
if (!function_exists('leGetDrawingsSinceDate')) {
...
if (!function_exists('leEscapeJsString')) {
...
/**
 * Fetch latest draw + analysis window
 */
...
/**
 * Frequency analysis — all 6 main ball columns
 */
[$mainCounts, $mainLastSeenIndex] = leInitRange($gameMainBallMin, $gameMainBallMax);

foreach ($rowsMain as $idx => $row) {
    foreach ($gameMainCols as $col) {
 ...
 * Chart data
 */
$mainChartLabels   = leBuildNaturalLabels($gameMainBallMin, $gameMainBallMax);
$mainChartValues   = [];
$mainRecencyValues = [];
...
[$counts50, ]  = leInitRange($gameMainBallMin, $gameMainBallMax);
[$counts300, ] = leInitRange($gameMainBallMin, $gameMainBallMax);
...
/**
 * Draw history for current draw — 6 main balls
 */
$drawHistoryRows = [];
if ($drawDate !== '') {
...
/**
 * Tool / route URLs — game-specific
 */
$skaiUrl    = '/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=' . rawurlencode($gId);
$aiUrl      = '/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=' . rawurlencode($gId);
$skipHitUrl = '/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=' . rawurlencode($gId);
$mcmcUrl    = '/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=' . rawurlencode($gId);

$archiveUrl = '/lottery-archives-pick6?' . http_build_query([
    'gId'       => $gId,
    'stateName' => (string) ($stateName ?? ''),
    'gName'     => (string) ($gName ?? ''),
    'sTn'       => strtolower((string) ($stateAbrev ?? '')),
]);

$lowestUrl = '/lowest-drawn-number-analysis?' . http_build_query([
    'gId'       => $gId,
    'stateName' => (string) ($stateName ?? ''),
    'gName'     => (string) ($gName ?? ''),
    'sTn'       => strtolower((string) ($stateAbrev ?? '')),
...
$formActionUrl = '/all-us-lotteries/results-analysis?' . http_build_query([
    'st'  => (string) ($stateAbrev ?? ''),
    'stn' => (string) ($stateName ?? ''),
    'gm'  => (string) ($gName ?? ''),
]) . '#tables';
 ...
 */
$jsonLdName = isset($stateName, $gName) && $stateName !== '' && $gName !== ''
    ? htmlspecialchars($stateName . ' ' . $gName . ' Pick 6 Results Analysis | LottoExpert.net', ENT_QUOTES, 'UTF-8')
    : 'Lottery Pick 6 Results Analysis | LottoExpert.net';

$jsonLdDesc = 'Verified draw results, frequency analysis, hot and cold numbers, recency, and historical draw behavior for '
    . htmlspecialchars((string) ($stateName ?? '') . ' ' . (string) ($gName ?? ''), ENT_QUOTES, 'UTF-8')
    . '. Data-driven lottery insights powered by LottoExpert.net.';
...
$jsonLdString = json_encode($jsonLdArray, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
?>
<script type="application/ld+json"><?php echo $jsonLdString !== false ? $jsonLdString : '{}'; ?></script>
<style>
:root{
  --skai-blue:#1C66FF;
  --deep-navy:#0A1A33;
...
.skai-chart-frame--tall{height:960px}
    ...
    <div class="skai-hero-inner">
      <div class="skai-hero-top">
        ...
        <div class="skai-hero-copy">
          <div class="skai-kicker">Results Intelligence &bull; Pick 6 &bull; Verified Draw &bull; Calm Analytical View</div>
          <h1 class="skai-title">
          ...
          <div class="skai-ball-row" aria-label="Latest Pick 6 drawn numbers">
          ...
          <div class="skai-hero-actions" aria-label="Primary actions">
            <a class="skai-btn skai-btn--primary" href="<?php echo htmlspecialchars($skaiUrl, ENT_QUOTES, 'UTF-8'); ?>">
              Open SKAI Analysis
            </a>
            <a class="skai-btn skai-btn--secondary" href="<?php echo htmlspecialchars($aiUrl, ENT_QUOTES, 'UTF-8'); ?>">
              AI Predictions
            </a>
          ...
          <div class="skai-advanced-links" aria-label="Advanced analysis tools">
            <a class="skai-mini-link" href="<?php echo htmlspecialchars($skipHitUrl, ENT_QUOTES, 'UTF-8'); ?>">Skip &amp; Hit Analysis</a>
            <a class="skai-mini-link" href="<?php echo htmlspecialchars($mcmcUrl, ENT_QUOTES, 'UTF-8'); ?>">MCMC Markov Analysis</a>
            <a class="skai-mini-link" href="<?php echo htmlspecialchars($heatmapUrl, ENT_QUOTES, 'UTF-8'); ?>">Heatmap Analysis</a>
          </div>
        </div>
        ...
        <aside class="skai-result-panel" aria-label="Latest draw details">
          ...
          <div class="skai-meta-stack">
            ...
            <div class="skai-meta-box">
              ...
              <span class="value">Recent activity, quiet stretches, and full distribution within the selected analysis window.</span>
            </div>
  ...
  <section class="skai-strip" aria-label="Key takeaways">
    ...
    <article class="skai-stat">
      ...
      <div class="skai-stat-body">
        ...
        <div class="skai-stat-note">Numbers currently sitting furthest from their most recent appearance.</div>
      </div>
    </article>
    ...
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Start with a clear high-level view of this Pick 6 game. This layer is designed for fast orientation: which numbers are most active, which are quiet, and how the current draw relates to recent history.
        </p>
      </div>
    </div>
  ...
  <section id="recency-deep-dive" class="skai-section" aria-labelledby="recency-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          This section makes the current Pick 6 draw easier to interpret. It shows how recently each latest number was previously seen, and how the perspective shifts when comparing a short recent window with a broader historical one.
        </p>
      </div>
    </div>
      ...
      <div class="skai-two-col">
        <div class="skai-card">
          <div class="skai-card-head skai-card-head--radiant">
            ...
            <span class="skai-card-sub">Previous appearance date and spacing for each of the 6 drawn values</span>
          </div>
          <div class="skai-card-body">
  ...
  <section id="frequency-deep-dive" class="skai-section" aria-labelledby="frequency-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Move from summary to full reference. The left panel shows the complete number distribution across all Pick 6 values 01&ndash;46. The right panel shows the recency distribution — how many draws ago each number was last seen.
        </p>
      </div>
    </div>
    ...
    <div class="skai-section-body">
      <div class="skai-two-col">
        <div class="skai-card">
          <div class="skai-card-head skai-card-head--horizon">
            ...
            <span class="skai-card-sub">All values 01&ndash;46 across the last <?php echo (int) $nodCurrentMain; ?> drawings</span>
          </div>
          <div class="skai-card-body">
        ...
        <div class="skai-card">
          <div class="skai-card-head skai-card-head--ember">
            ...
            <span class="skai-card-sub">Draws since last appearance for each number 01&ndash;46</span>
          </div>
          <div class="skai-card-body">
            <div class="skai-chart-frame skai-chart-frame--tall">
      ...
      <div class="skai-note">
        The complete distribution is best used as a reference layer. The overview modules above are optimized for quick reading; this section is optimized for thorough review of all 46 numbers across the full Pick 6 range.
      </div>
    </div>
  </section>
  ...
  <section id="tables" class="skai-section" aria-labelledby="tables-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Use the table for exact counts, recency, and personal tracking. Quick filters help narrow the view without losing full access to the complete dataset. Adjust the analysis window to reload counts for a different draw range.
        </p>
      </div>
    </div>

    <div class="skai-controls">
      <form name="fqsearch" method="post" action="<?php echo htmlspecialchars($formActionUrl, ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <div class="skai-section-body">
      <div class="skai-two-col">
        <div class="skai-card">
          <div class="skai-card-head skai-card-head--horizon">
            Pick 6 numbers table
            <span class="skai-card-sub">Exact counts and recency for all values 01&ndash;46</span>
          </div>
          ...
          <div class="skai-table-wrap">
            <table id="skai-main-table" class="skai-table" aria-label="Pick 6 number frequency table">
              <thead>
                <tr>
                  <th>Number</th>
                  <th>Drawn Times</th>
              ...
              <tbody>
                <?php for ($i = $gameMainBallMin; $i <= $gameMainBallMax; $i++) : ?>
                  <?php
          ...
          <div class="skai-tracked">
            ...
            <div class="skai-chip-wrap" id="mainTrackedWrap">
              <div class="skai-empty">Select numbers above to create a short tracked set for comparison across this page.</div>
            </div>
          </div>
        </div>

        <div style="display:flex;flex-direction:column;gap:14px;min-width:0;">
          <div class="skai-archive-card">
            <h3>Lottery Archives</h3>
            <p>Browse the complete historical draw record for <?php echo htmlspecialchars((string) ($stateName ?? '') . ' ' . (string) ($gName ?? ''), ENT_QUOTES, 'UTF-8'); ?>. Review past results draw by draw for deeper pattern recognition.</p>
            <a class="skai-tool-cta" href="<?php echo htmlspecialchars($archiveUrl, ENT_QUOTES, 'UTF-8'); ?>">Open Lottery Archives</a>
          </div>

          <div class="skai-archive-card">
            <h3>Lowest Number Analysis</h3>
            <p>Explore how the lowest drawn number behaves across historical draws. A useful supplemental signal when reviewing Pick 6 frequency patterns.</p>
            <a class="skai-tool-cta" href="<?php echo htmlspecialchars($lowestUrl, ENT_QUOTES, 'UTF-8'); ?>">Open Lowest Number Analysis</a>
          </div>
    ...
    <div class="skai-section-body">
      <div class="skai-tool-grid">
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            <p class="skai-tool-copy">
              Best next step for a broader multi-signal view. Use this after reviewing frequency and recency to move into the main SKAI intelligence workflow for this Pick 6 game.
            </p>
            <a class="skai-tool-cta" href="<?php echo htmlspecialchars($skaiUrl, ENT_QUOTES, 'UTF-8'); ?>">Open SKAI Analysis</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            <p class="skai-tool-copy">
              Use when you want a model-driven complement to the historical view shown on this page. Powered by the LottoExpert AI engine.
            </p>
            <a class="skai-tool-cta" href="<?php echo htmlspecialchars($aiUrl, ENT_QUOTES, 'UTF-8'); ?>">Open AI Predictions</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            <p class="skai-tool-copy">
              Useful for users who want to compare appearance spacing and interruption behavior after reviewing current Pick 6 frequency.
            </p>
            <a class="skai-tool-cta" href="<?php echo htmlspecialchars($skipHitUrl, ENT_QUOTES, 'UTF-8'); ?>">Open Skip &amp; Hit</a>
          </div>
        </article>
      </div>

      <div class="skai-utility-grid">
        <a class="skai-utility-link" href="<?php echo htmlspecialchars($mcmcUrl, ENT_QUOTES, 'UTF-8'); ?>">MCMC Markov Analysis</a>
        <a class="skai-utility-link" href="<?php echo htmlspecialchars($heatmapUrl, ENT_QUOTES, 'UTF-8'); ?>">Heatmap Analysis</a>
        <a class="skai-utility-link" href="<?php echo htmlspecialchars($archiveUrl, ENT_QUOTES, 'UTF-8'); ?>">Lottery Archives</a>
        <a class="skai-utility-link" href="<?php echo htmlspecialchars($lowestUrl, ENT_QUOTES, 'UTF-8'); ?>">Lowest Number Analysis</a>
      </div>
    </div>
  </section>
  ...
  <section class="skai-section" aria-labelledby="method-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          This page is designed to help users understand recent and historical behavior of this Pick 6 game more clearly — not to imply certainty.
        </p>
      </div>
    </div>
